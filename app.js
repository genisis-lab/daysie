...
$('#sendMagicLink').onclick = async () => {
  ...
  try {
    ...
    const res = await fetch('https://daysie-api.YOUR_SUBDOMAIN.workers.dev/auth/request', {
      method: 'POST',
...
$('#verifyCode').onclick = async () => {
  ...
  try {
    const res = await fetch('https://daysie-api.YOUR_SUBDOMAIN.workers.dev/auth/verify', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
async function syncToCloud() {
  ...
  try {
    await fetch('https://daysie-api.YOUR_SUBDOMAIN.workers.dev/data', {
      method: 'POST',
...
async function pullFromCloud() {
  if (!settings.authToken) return;
  try {
    const res = await fetch('https://daysie-api.YOUR_SUBDOMAIN.workers.dev/data', {
...
$('#subscribePushBtn').onclick = async () => {
  ...
  try {
    ...
    const res = await fetch('https://daysie-api.YOUR_SUBDOMAIN.workers.dev/push/subscribe', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${settings.authToken}` },
